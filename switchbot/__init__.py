...
def _process_wocontactsensor(data: bytes) -> dict[str, bool | int]:
    ...
    return {
        ...
        "battery": data[2] & 0b01111111,
        "door_open": data[3] & 0b01100010 == 0b00000010,
        "door_timeout": data[3] & 0b00000110 == 0b00000110,
        "is_light": bool(data[3] & 0b00000001),
        "button_count": bool(data[3] & 0b00001111),
    }
...
def parse_advertisement_data(
    ...
    supported_types: dict[str, dict[str, Any]] = {
        "d": {"modelName": "WoContactSensor", "func": _process_wocontactsensor},
...
class GetSwitchbotDevices:
    ...
    async def get_contactsensors(self) -> dict[str, SwitchBotAdvertisement]:
        """Return all WoContactSensor/Contact sensor devices with services data."""
